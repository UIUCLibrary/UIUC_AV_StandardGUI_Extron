...
from modules.project.PrimitiveObjects import ControlObject, FeedbackObject
...
class SelectObject(Button):
    ...
    def Control(self, val) -> None:
        raise ValueError('Overriding Control property directly is disallowed. Use "SetControlObject" instead.')
