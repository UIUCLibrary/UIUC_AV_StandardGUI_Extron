...
class ControlObject():
    ...
    def LinkControlObject(self, ControlObject: Union['ExButton', 'ExSlider', 'RefButton'], ControlCollection: Union['RadioSet', 'SelectSet', 'VariableRadioSet', 'ScrollingRadioSet'] = None):
        ...
        if ControlCollection is not None and type(ControlCollection) not in [RadioSet, SelectSet, VariableRadioSet, ScrollingRadioSet]:
